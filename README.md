...
1. The repository stores Machine Learning programs in two formats.
2. `.ipynb` files allow step-by-step execution with explanations and visualizations.
3. `.py` files allow direct execution of Machine Learning programs from the command line.
4. Users can choose the format based on their learning or execution preference.
